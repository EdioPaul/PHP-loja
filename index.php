...
<html>
<head>
<title>Comércio de Semi-Jóias</title>
...
<body>
     <div class="header-top">
	   <div class="wrap"> 
			 ...
			 <div class="cssmenu">
				<ul>
					<li class="active"><a href="login2.php">Conta</a></li> |
	...
	<div class="header-bottom">
	    <div class="wrap">
			<div class="header-bottom-left">
				<div class="logo">
					<a href="index.php"><img src="images/logo_bigtudov2.PNG" alt=""/></a>
				</div>
				<div class="menu">
	            <ul class="megamenu skyblue">
			<li class="active grid"><a href="index.php">Início</a></li>
			<li><a class="color4" href="#">Feminino</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
				...
				<li><a class="color5" href="#">Masculino</a>
				<div class="megapanel">
					<div class="col1">
							<div class="h_nav">
								<h4>Contact Lenses</h4>
				...
				<li><a class="color6" href="other.html">Outros</a></li>
			</ul>
			</div>
		</div>
  ...
  <!-- start slider -->
    <div id="fwslider">
        <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
                    <img src="images/exemplo_colar.jpeg" alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h4 class="title">Peças que combinam com seu estilo!</h4>
                        <!-- /Text title -->
                        
                        <!-- Text description -->
                        <p class="description">Experimente peças com a sua marca!</p>
                        <!-- /Text description -->
                    </div>
                </div>
                 <!-- /Texts container -->
            ...
            <div class="slide">
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h4 class="title">Escolha a peça que combina com você! </h4>
	...
	<div class="wrap">
		<div class="section group">
		  <div class="cont span_2_of_3">
		  	<h2 class="head">Produtos em Alta</h2>
			<div class="top-box">
			 <div class="col_1_of_3 span_1_of_3"> 
			   <a href="single.html">
				<div class="inner_content clearfix">
					<div class="product_image">
						<img src="images/fotos_pcs/image001.png" alt=""/>
					</div>
                    ...
                    <div class="price">
					   <div class="cart-left">
							...
							<div class="price1">
							  <span class="actual">R$39,90</span>
							</div>
						</div>
